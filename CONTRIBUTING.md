...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/glyphink/website
   cd website
   ```
...
```sh
https://github.com/glyphink/website/compare/main...$branch
```
...
[qa]: https://github.com/glyphink/website/discussions/new?category=q-a
